...
const zhCN: Messages = {
  ...
  'settings.plugins.subtitle': '启用内置功能，或管理已安装插件。',
  'settings.plugins.install': '导入 ZIP',
  'settings.plugins.update': '更新',
  'settings.plugins.delete': '删除',
  'settings.plugins.installHint': '导入 ZIP 安装插件',
  'settings.plugins.updateHint': '使用“更新”导入新版 ZIP',
  'settings.plugins.thirdParty.note': '已安装插件目前仅保存元数据（不会执行第三方代码）。',
  'settings.plugins.toast.installed': '插件已安装',
  'settings.plugins.toast.updated': '插件已更新',
  'settings.plugins.toast.deleted': '插件已删除',

  'settings.plugins.repo.title': '插件仓库（Git）',
  'settings.plugins.repo.url': '仓库地址',
  'settings.plugins.repo.url.desc': '预留：用于从 Git 仓库安装插件',
  'settings.plugins.repo.url.placeholder': 'https://github.com/owner/repo',
  'settings.plugins.repo.install': '安装',
  'settings.plugins.repo.toast.reserved': '预留功能：已保存仓库地址（Git 安装将在后续版本实现）。',
  'settings.plugins.ai.name': 'AI 助手',
  'settings.plugins.ai.desc': '启用终端里的 AI 对话与自动建议',
  'settings.plugins.zebra.name': '斑马纹代码块',
  'settings.plugins.zebra.desc': '启用终端输出的交替背景色块',
  'settings.plugins.commandCandidates.name': '命令候选',
  'settings.plugins.commandCandidates.desc': '输入时从远端 $PATH 提示命令',
